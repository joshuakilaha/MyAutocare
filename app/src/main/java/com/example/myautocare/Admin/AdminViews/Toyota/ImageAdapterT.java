...
public class ImageAdapterT extends RecyclerView.Adapter<ImageAdapterT.ImageViewHolder>  {
    private Context mContext;
    private List<UploadT> mUploads;
    private OnItemClickListener mListener;

    public ImageAdapterT(Context context, List<UploadT> uploads) {
        mContext = context;
        mUploads = uploads;
    }
    ...
    public void onBindViewHolder(ImageViewHolder holder, int position) {
        UploadT uploadCurrent = mUploads.get(position);
